...
$router->get('/mahasiswa/dokumen/view/:id', 'MahasiswaController@viewDokumen');
...
$router->post('/mahasiswa/pengajuan/upload-laporan', 'MahasiswaController@uploadLaporan');
...
$router->get('/sekretariat/dokumen/view/:id', 'SekretariatController@viewDokumen');
