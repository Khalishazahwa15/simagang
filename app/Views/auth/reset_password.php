<div class="auth-card" style="padding: 40px; box-sizing: border-box;">
    ...
    <form action="<?= BASE_URL ?>/reset-password?token=<?= htmlspecialchars($token) ?>" method="POST">
        ...
        <div class="form-group" style="margin-bottom: 20px;">
            <label for="app-views-auth-reset-password-password" class="form-label" style="display: block; margin-bottom: 8px; font-weight: 500; font-size: var(--text-body-sm); color: var(--text-primary);">Password Baru</label>
        ...
        <div class="form-group" style="margin-bottom: 32px;">
            <label for="app-views-auth-reset-password-confirm_password" class="form-label" style="display: block; margin-bottom: 8px; font-weight: 500; font-size: var(--text-body-sm); color: var(--text-primary);">Konfirmasi Password Baru</label>
            <div style="position: relative;">
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="position: absolute; left: 16px; top: 50%; transform: translateY(-50%); color: var(--text-secondary);"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
        ...
        <button type="submit" class="btn btn-primary" style="width: 100%; height: 48px; display: flex; align-items: center; justify-content: center; gap: 8px; background: var(--primary); color: var(--bg-card); border: none; border-radius: 8px; font-weight: 500; font-size: var(--text-body-sm); cursor: pointer; transition: background 0.2s;">
