<div class="auth-card" style="padding: 40px; box-sizing: border-box;">
    ...
    <?php if ($flash = \App\Core\Session::getFlash('success')): ?>
        <div style="margin-bottom: 24px; padding: 12px 16px; background: #ECFDF5; border-left: 4px solid #059669; border-radius: 4px;">
            <p style="margin: 0; font-size: 13px; color: #065F46;"><?= htmlspecialchars($flash) ?></p>
        </div>
    <?php endif; ?>
    ...
    <form action="<?= BASE_URL ?>/forgot-password" method="POST">
        ...
        <div class="form-group" style="margin-bottom: 24px;">
            <label class="form-label" style="display: block; margin-bottom: 8px; font-weight: 600; font-size: 13px; color: var(--text-primary);">Alamat Email</label>
