        ...
        <div style="width: 100%; max-width: 440px;">
            ...
            <form action="<?= BASE_URL ?>/register" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input id="app-views-auth-register-nama" type="text" name="nama" class="form-control" placeholder="Sesuai KTP/KTM" required>
                </div>
                
                <div class="form-group">
                    <label for="app-views-auth-register-email" class="form-label required">Alamat Email</label>
                    <input id="app-views-auth-register-email" type="email" name="email" class="form-control" placeholder="Gunakan email universitas jika ada" required>
                </div>
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <input id="app-views-auth-register-nim" type="text" name="nim" class="form-control" placeholder="Nomor Induk Mahasiswa" required>
                    </div>
                    <div class="form-group">
                        <label for="app-views-auth-register-semester" class="form-label required">Semester</label>
                        <input id="app-views-auth-register-semester" type="number" name="semester" class="form-control" placeholder="Contoh: 6" min="1" max="14" required>
                    </div>
                </div>

                <div class="form-group">
                    <label for="app-views-auth-register-universitas" class="form-label required">Universitas</label>
                    <input id="app-views-auth-register-universitas" type="text" name="universitas" class="form-control" placeholder="Contoh: Universitas Lampung" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="app-views-auth-register-nomor_hp" type="text" name="nomor_hp" class="form-control" placeholder="Contoh: 081234567890" required>
                </div>

                <div class="form-group">
                    <label for="app-views-auth-register-alamat" class="form-label required">Alamat</label>
                    <textarea id="app-views-auth-register-alamat" name="alamat" class="form-control" placeholder="Alamat tempat tinggal saat ini" rows="2" required></textarea>
                </div>
