    ...
    <div class="auth-brand-side">
        ...
        <div style="position: relative; z-index: 1;">
            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 48px;">
                <img src="<?= aset('assets/img/bappeda-logo-kecil.png') ?>" alt="Logo Bappeda Provinsi Lampung" style="height: 36px; width: auto;">
                <div>
    ...
    <div style="flex: 1; display: flex; align-items: center; justify-content: center; background-color: var(--bg-main); padding: 32px;">
        <div style="width: 100%; max-width: 400px;">
            <div class="mobile-logo-only" style="display: none; margin-bottom: 32px; align-items: center; gap: 12px;">
                <img src="<?= aset('assets/img/bappeda-logo-kecil.png') ?>" alt="Logo Bappeda Provinsi Lampung" style="height: 30px; width: auto;">
                <div>
