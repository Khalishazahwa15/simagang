...
<div class="public-info-page public-process-page min-h-screen bg-slate-50">
    ...
    <div class="mx-auto max-w-5xl px-6 py-12 sm:px-8 lg:px-12 lg:py-16">
        ...
        <div class="grid gap-4 pb-12 md:grid-cols-3 lg:pb-16">
            ...
            foreach ($overviews as $i => $item): ?>
                <div class="info-summary-card rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div style="font-family: var(--font-body); font-size: 12px; font-weight: 500; letter-spacing: 0.10em; color: var(--text-secondary); text-transform: uppercase; margin-bottom: 8px;"><?= $item['label'] ?></div>
        ...
        <div style="margin-bottom: 80px;">
            <h2 class="mb-8 text-2xl font-semibold text-slate-950 sm:text-3xl">Tahapan Proses</h2>
                ...
                ?>
                    <div class="process-step layout-step" style="gap: 0">
                        ...
                        <div style="display: flex; flex-direction: column; align-items: center; padding-top: 4px;">
                            ...
                            <?php if (!$isLast): ?>
                                <div style="width: 2px; flex: 1; background: var(--color-border); min-height: 40px; margin-top: 4px;"></div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div style="padding-left: 24px; padding-bottom: <?= $isLast ? '0' : '48px' ?>;">
                            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 6px;">
                                <h3 style="font-family: var(--font-display); font-size: var(--text-h3); font-weight: 600; color: var(--text-primary); letter-spacing: -0.01em; margin: 0;"><?= $step['title'] ?></h3>
                                <span style="background: <?= $badge['bg'] ?>; color: <?= $badge['text'] ?>; font-family: var(--font-body); font-size: 12px; font-weight: 500; letter-spacing: 0.08em; padding: 3px 10px; border-radius: 99px; text-transform: uppercase;"><?= $step['badge'] ?></span>
                            </div>
                            <div style="font-family: var(--font-body); font-size: 12px; font-weight: 500; letter-spacing: 0.10em; color: var(--text-secondary); text-transform: uppercase; margin-bottom: 10px;"><?= $step['subtitle'] ?> &middot; <?= $step['duration'] ?></div>
        ...
        <div class="bottom-cta">
            <div class="bottom-cta-copy">
                <div style="font-family: var(--font-body); font-size: 12px; font-weight: 500; letter-spacing: 0.12em; color: var(--color-accent-soft); text-transform: uppercase; margin-bottom: 8px;">Siap Mengajukan?</div>
                <h3 style="font-family: var(--font-display); font-size: var(--text-h3); font-weight: 600; color: var(--bg-main); line-height: 1.2; margin: 0;">Mulai proses pengajuan Anda sekarang</h3>
            </div>
            ...
            <div class="cta-actions">
                ...
                <a href="<?= BASE_URL ?>/login" class="btn" style="padding: 12px 24px; background: var(--accent); border: none; border-radius: 8px; color: var(--primary-dark); font-weight: 600; text-decoration: none;">
                    Ajukan Magang
                </a>
            </div>
        </div>
