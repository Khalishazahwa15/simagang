    ...
    <div class="mx-auto max-w-5xl px-6 py-12 sm:px-8 lg:px-12 lg:py-16">
        ...
        <div class="grid gap-4 pb-12 md:grid-cols-3 lg:pb-16">
            ...
            foreach ($overviews as $i => $item): ?>
                <div class="info-summary-card rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div style="font-family: var(--font-body); font-size: 12px; font-weight: 600; letter-spacing: 0.10em; color: var(--text-secondary); text-transform: uppercase; margin-bottom: 8px;"><?= $item['label'] ?></div>
                    ...
                    <div class="process-step layout-step" style="gap: 0">
                        ...
                        <div style="padding-left: 24px; padding-bottom: <?= $isLast ? '0' : '48px' ?>;">
                            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 6px;">
                                ...
                                <span style="background: <?= $badge['bg'] ?>; color: <?= $badge['text'] ?>; font-family: var(--font-body); font-size: 12px; font-weight: 600; letter-spacing: 0.08em; padding: 3px 10px; border-radius: 99px; text-transform: uppercase;"><?= $step['badge'] ?></span>
                            </div>
                            <div style="font-family: var(--font-body); font-size: 12px; font-weight: 600; letter-spacing: 0.10em; color: var(--text-secondary); text-transform: uppercase; margin-bottom: 10px;"><?= $step['subtitle'] ?> &middot; <?= $step['duration'] ?></div>
        ...
        <div class="bottom-cta">
            <div class="bottom-cta-copy">
                <div style="font-family: var(--font-body); font-size: 12px; font-weight: 600; letter-spacing: 0.12em; color: var(--color-accent-soft); text-transform: uppercase; margin-bottom: 8px;">Siap Mengajukan?</div>
