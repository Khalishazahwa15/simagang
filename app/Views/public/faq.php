...
<div class="public-info-page public-faq-page min-h-screen bg-slate-50">
    <!-- Header -->
                        ...
                        <?php foreach ($cat['items'] as $idx => $item): ?>
                            <div class="faq-accordion <?= $idx === 0 ? 'active' : '' ?>">
                                ...
                                <div class="faq-content">
                                    <p style="font-family: var(--font-body); font-size: var(--text-body-sm); color: var(--text-primary); line-height: 1.8; margin: 0;"><?= $item['a'] ?></p>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
    ...
    <div style=" margin: 0 auto 80px; padding: 0 40px;">
        <div class="bottom-cta" style="margin: 0;">
            <div class="bottom-cta-copy">
                <div style="font-family: var(--font-body); font-size: 12px; font-weight: 600; letter-spacing: 0.12em; color: var(--accent-dark); text-transform: uppercase; margin-bottom: 8px;">Portal SIMAGANG</div>
