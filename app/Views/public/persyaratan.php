    ...
    <div class="mx-auto max-w-5xl px-6 py-12 sm:px-8 lg:px-12 lg:py-16">
                    ...
                    <div style="padding-top: 16px; display: flex; flex-direction: column; gap: 10px;">
                        <?php foreach ($eligibles as $e): ?>
                            <div style="display: flex; gap: 14px; align-items: flex-start;">
                                ...
                                <p style="font-family: var(--font-body); font-size: var(--text-body-sm); color: var(--text-primary); line-height: 1.7; margin: 0;"><?= $e ?></p>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </div>
        ...
        <div class="bottom-cta" style="margin-top: 48px;">
            <div class="bottom-cta-copy">
                <div style="font-family: var(--font-body); font-size: 12px; font-weight: 600; letter-spacing: 0.12em; color: var(--accent-dark); text-transform: uppercase; margin-bottom: 8px;">Sudah Siap?</div>
