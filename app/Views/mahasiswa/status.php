...
<div style="display: flex; flex-direction: column; gap: 24px;">
    ...
    <div style="background: var(--bg-soft); border: 1px solid var(--border); border-radius: 10px; padding: 24px; display: flex; justify-content: space-between; align-items: flex-start;">
        <div>
            <div style="font-family: var(--font-body); font-size: 12px; font-weight: 500; color: var(--text-secondary); letter-spacing: 1.1px; text-transform: uppercase; margin-bottom: 8px;">
                Nomor Pengajuan
            </div>
        ...
        <!-- STATUS BADGE -->
        <div style="padding: 6px 16px; border-radius: 4px; font-family: var(--font-body); font-size: var(--text-body-sm); font-weight: 500; letter-spacing: 0.65px; text-transform: uppercase; <?= getStatusBadgeStyle($pengajuan['status']) ?>">
    ...
    <div style="background: var(--bg-soft); border: 1px solid var(--border); border-radius: 10px; padding: 24px;">
        <div style="font-family: var(--font-body); font-size: 12px; font-weight: 500; color: var(--text-secondary); letter-spacing: 1.2px; text-transform: uppercase; margin-bottom: 20px;">
            Tahapan Proses
        </div>
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; padding-top: 8px;">
            ...
            <div style="flex: 1; display: flex; flex-direction: column; align-items: center; position: relative;">
                ...
                <div style="width: 32px; height: 32px; border-radius: 50%; background: <?= $step == $i ? 'var(--accent)' : 'transparent' ?>; border: 2px solid <?= $step == $i ? 'var(--accent)' : 'var(--border)' ?>; display: flex; align-items: center; justify-content: center; z-index: 1; position: relative; margin-bottom: 12px;">
                    <span style="font-family: var(--font-mono); font-size: 12px; font-weight: 500; color: <?= $step == $i ? 'var(--primary-dark)' : 'var(--text-secondary)' ?>;"><?= str_pad($i + 1, 2, '0', STR_PAD_LEFT) ?></span>
                </div>
                <?php endif; ?>
    ...
    <div style="background: var(--bg-soft); border: 1px solid var(--border); border-radius: 10px;">
        <div style="padding: 16px 24px; border-bottom: 1px solid var(--border);">
            <div style="font-family: var(--font-body); font-size: var(--text-body-sm); font-weight: 500; color: var(--text-primary);">Riwayat Aktivitas</div>
        </div>
        <div style="padding: 0;">
            ...
            <?php else: ?>
                ...
                <div style="display: flex; gap: 16px; padding: 14px 24px; border-bottom: <?= $index < count($riwayat) - 1 ? '1px solid var(--border)' : 'none' ?>; align-items: flex-start;">
                    ...
                    <div>
                        <div style="font-family: var(--font-body); font-size: var(--text-body-sm); font-weight: 500; color: var(--text-primary); margin-bottom: 2px;">
                            <?php
    ...
    <div style="background: var(--bg-soft); border: 1px solid var(--border); border-radius: 10px; margin-top: 8px;">
        <div style="padding: 16px 24px; border-bottom: 1px solid var(--border); background: rgba(217,165,29,0.05);">
            <div style="font-family: var(--font-body); font-size: var(--text-body-sm); font-weight: 500; color: var(--text-primary);">Formulir Perbaikan Dokumen</div>
        </div>
    ...
    <div style="background: var(--bg-soft); border: 1px solid var(--border); border-radius: 10px; margin-top: 8px;">
        <div style="padding: 16px 24px; border-bottom: 1px solid var(--border); background: rgba(37, 99, 235, 0.05);">
            <div style="font-family: var(--font-body); font-size: var(--text-body-sm); font-weight: 500; color: var(--primary);">Tawaran Divisi Alternatif</div>
        </div>
        <div style="padding: 24px;">
    ...
    <div style="background: var(--bg-soft); border: 1px solid var(--border); border-radius: 10px; margin-top: 8px;">
        <div style="padding: 16px 24px; border-bottom: 1px solid var(--border); background: rgba(37, 99, 235, 0.05);">
            <div style="font-family: var(--font-body); font-size: var(--text-body-sm); font-weight: 500; color: var(--primary);">Unggah Laporan Akhir Magang</div>
        </div>
        <div style="padding: 24px;">
            <p style="font-family: var(--font-body); font-size: 14px; color: var(--text-secondary); margin-bottom: 20px;">
    ...
    <div class="card fade-up" style="margin: 0;">
        <div class="card-body" style="display: flex; align-items: center; justify-content: space-between; gap: 20px; flex-wrap: wrap;">
            <div>
                <div style="font-family: var(--font-body); font-weight: 500; font-size: 14px; color: var(--text-primary); margin-bottom: 4px;">
