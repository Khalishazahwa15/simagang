...
<div style="display: flex; flex-direction: column; gap: 24px;">
    ...
    <div style="background: var(--color-warning-soft); border: 1px solid var(--color-warning-border); border-radius: 10px; padding: 16px 20px; margin-bottom: 24px; display: flex; align-items: flex-start; gap: 14px;">
        ...
        <div style="flex: 1;">
            <div style="font-family: var(--font-body); font-weight: 500; font-size: 14px; color: var(--color-warning-ink); margin-bottom: 4px;">Profil belum lengkap</div>
    ...
    <div>
        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
            ...
            <div style="font-family: var(--font-body); font-size: 12px; font-weight: 500; color: var(--text-secondary); letter-spacing: 0.88px; text-transform: uppercase;">Pengaturan Akun</div>
        </div>
    ...
    <div class="card fade-up interactive-card fade-up interactive-card" style="margin-bottom: 0;">
        <div style="padding: 24px; border-bottom: 1px solid var(--border); display: flex; align-items: center; gap: 16px; background: var(--bg-soft);">
            ...
            <div>
                <div style="font-family: var(--font-body); font-size: 18px; font-weight: 600; color: var(--text-primary); margin-bottom: 4px;"><?= htmlspecialchars($namaLengkap) ?></div>
        ...
        <div class="card-body" style="padding: 32px 24px;">
            <form action="<?= BASE_URL ?>/mahasiswa/profil/update" method="POST">
                ...
                <div style="font-family: var(--font-body); font-size: 12px; font-weight: 500; letter-spacing: 0.5px; color: var(--text-primary); text-transform: uppercase; margin-bottom: 16px;">Data Pribadi</div>
                ...
                <div style="font-family: var(--font-body); font-size: 12px; font-weight: 500; letter-spacing: 0.5px; color: var(--text-primary); text-transform: uppercase; margin-bottom: 16px;">Informasi Akademik</div>
