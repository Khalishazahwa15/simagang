<div class="mb-6">
    <div class="d-flex align-center justify-between">
        <div>
            <h1 class="card-title" style="font-family: var(--font-display); font-size: 28px; font-weight: 400; text-transform: none; letter-spacing: -0.01em; margin: 0 0 4px 0;">Daftar Peserta Aktif</h1>
            <p class="text-muted" style="font-family: var(--font-body); font-size: 13.5px; margin: 0;">Kelola data mahasiswa yang sedang menjalani masa magang saat ini.</p>
        </div>
    </div>
</div>
...
<form method="GET" action="<?= BASE_URL ?>/sekretariat/peserta">
    <div class="d-flex" style="gap: 12px; margin-bottom: 20px; flex-wrap: wrap;">
        <div style="position: relative; flex: 1 1 240px;">
            ...
            <input type="text" name="q" value="<?= htmlspecialchars($q ?? '') ?>" placeholder="Cari nama, institusi, atau bidang..." style="width: 100%; padding: 9px 14px 9px 36px; background: var(--bg-main); border: 1px solid var(--border); border-radius: 8px; font-family: var(--font-body); font-size: 13.5px; color: var(--text-primary); outline: none;">
        </div>
