...
<div style="font-family: 'Plus Jakarta Sans', sans-serif; max-width: 1040px; display: flex; flex-direction: column; gap: 20px;">
    ...
    <div style="background: var(--bg-card); border: 0.666667px solid var(--border); border-radius: 10px; padding: 20px 24px;">
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 12px;">
            <a href="<?= BASE_URL ?>/sekretariat/laporan/export?filter=semua" style="text-decoration: none; padding: 12px 18px; background: #F7F4EC; border: 1px solid var(--border); border-radius: 8px; display: inline-flex; flex-direction: column; justify-content: center; min-width: 280px; flex: 1;">
            ...
            <a href="<?= BASE_URL ?>/sekretariat/laporan/export?filter=baru" style="text-decoration: none; padding: 12px 18px; background: var(--bg-main); border: 1px solid var(--border); border-radius: 8px; display: inline-flex; flex-direction: column; justify-content: center; min-width: 280px; flex: 1;">
                <div style="display: flex; align-items: center; gap: 7px; margin-bottom: 4px;">
            ...
            <a href="<?= BASE_URL ?>/sekretariat/laporan/export?filter=aktif" style="text-decoration: none; padding: 12px 18px; background: var(--bg-main); border: 1px solid var(--border); border-radius: 8px; display: inline-flex; flex-direction: column; justify-content: center; min-width: 280px; flex: 1;">
                <div style="display: flex; align-items: center; gap: 7px; margin-bottom: 4px;">
            ...
            <a href="<?= BASE_URL ?>/sekretariat/laporan/export?filter=selesai" style="text-decoration: none; padding: 12px 18px; background: var(--bg-main); border: 1px solid var(--border); border-radius: 8px; display: inline-flex; flex-direction: column; justify-content: center; min-width: 280px; flex: 1;">
                <div style="display: flex; align-items: center; gap: 7px; margin-bottom: 4px;">
            ...
            <a href="<?= BASE_URL ?>/sekretariat/laporan/export?filter=ditolak" style="text-decoration: none; padding: 12px 18px; background: var(--bg-main); border: 1px solid var(--border); border-radius: 8px; display: inline-flex; flex-direction: column; justify-content: center; min-width: 280px; flex: 1;">
                <div style="display: flex; align-items: center; gap: 7px; margin-bottom: 4px;">
